...
<div class="container">
    ...
    <%
        List<AlunoModel> lista = AlunoDAO.getAllAlunos();
    ...
    <table class="table">
        ...
        <th scope="col"><p class="form-control" type="text" id="totalemuso" style="width:50px">5000</p></th> colocar aqui a qtd de linhas -->
    </table>
        ...
        <thead>
            <tr>
                ...
                <th scope="col">Turma</th>
                    <c:forEach items="${lista}" var="alunoModel" >
                        <tr>
                            <<td>${alunoModel.getId()}</td>
                            <<td>${alunoModel.getNome()}</td>
                            <<td>${alunoModel.getMatricula()}</td>
