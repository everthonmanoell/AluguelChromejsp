        ...
        <div class="container containerMeio">
            ...
            <form action="" method="post">
                <div class="fonteCoordenador">
                    ...
                    <input type="text" value="" class="form-control" id="nomecompleto" placeholder="Nome completo do aluno" name="nomecompleto" required>
                    </div>
                    
                    <div class="mb-3 mt-3">
                        <label for="matricula" class="form-label"><a>Matrícula do aluno:</a></label>
                        <input type="text" value="" name="matricula" class="form-control" id="matricula" aria-describedby="matricula" placeholder="Digite a matricula do aluno">
                    </div>
                                        
                    
                    <div class="mb-3 mt-3">
                        <label for="dataagenda" class="form-label"><a>Data do agendamento</a></label>
                        <input type="date"  value="" class="form-control"  id="dataagenda" placeholder="" name="dataagenda" required/>
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="horaagenda" class="form-label"><a>Hora do agendamento</a></label>
                        <input type="time"  value="" class="form-control w-25" min="08:00" max="21:00" id="horaagenda" placeholder="" name="horaagenda" required />
</div>
