...
<%@page import="control.ControleBancoAgendar"%>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Relatório Dos Agendamentos Concluídos</title>
</head>
<%
...
<body>
    <div class="bordaDoTopo">
        <div class="container-fluid">     
            <a href="home.jsp"><button class="botoesDoTopo">INÍCIO</button></a>
    ...
    <div class="container">
        <div class="containerRelatorio">
            ...
            <main>
                <table class="table">
                    <form action="pesquisarAgendados.jsp" method="get">
                        ...
                        <th scope="col" id="totalemuso" style="float:inline-end;">
                            TOTAL CONCLUÍDOS:
                            <% 
                                int totalConcluidos = pesquisa != null && !pesquisa.isEmpty() ? control.contarAgendamentosComPesquisa(pesquisa) : control.quantidadeAgendamentos();
                                out.print(totalConcluidos);
                            %>
                        </th>
                    </form>
                </table>
            ...
            <table class="table table-striped table-sm table-hover">
                <thead>
                    <tr>
                        <th scope="col" class="tabela">Matrícula Aluno</th>
                        <th scope="col" class="tabela">Data Agendada</th>
                        <th scope="col" class="tabela">Hora Agendada</th>
                        <th scope="col" class="tabela">Situação</th>
                        <th scope="col" class="tabela">Data Para o Aluguel</th>
                        <th scope="col" class="tabela">Ações</th>
                    </tr>
                </thead>
                <tbody>
                    <%
                        if (pesquisa == null || pesquisa.isEmpty()) {
                            out.print(control.listarAgendamentosConcluidos());
                        } else {
                            out.print(control.listarPesquisaAgendamentos(pesquisa));
                        }
                    %>
                </tbody>
            </table>
